...
public class AboutCmdForm extends BaseForm{
    ...
    public AboutCmdForm(com.codename1.ui.util.Resources resourceObjectInstance ,int idcmd,String etatl) {
        ...
        initGuiBuilderComponents(resourceObjectInstance, idcmd , etatl);
        
    }
    
     private void initGuiBuilderComponents(com.codename1.ui.util.Resources resourceObjectInstance, int idcmd,String etatl) {
        ...
        globc.add(entetec).add(container_1).add(panc).add(totalc);
        
        if (etatl.equals("livree") && pan.get(0).getEtatc().equals("Acceptee")){
        ...
        globc.add(Reclamer);
         ...
         //int idc=pan.get(0).getIdcmd();
        System.out.println(idcmd);
        String refC=pan.get(0).getRefc();
        Reclamer.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent evt) {
               new AjoutCmdRecForm(resourceObjectInstance,idcmd, refC , etatl).show();
            }
        });
