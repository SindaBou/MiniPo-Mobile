...
public class ReclamationClient {
    ...
    public ReclamationClient(int id, int idcatrec, int idcmd, String nom, String objet, String description, String image) {
        this.id = id;
...
//constructeuuuur ajouter
    ...
    public ReclamationClient(int idcatrec, int idcmd, String objet, String description, int id, String fileNameInServer, int idcmd0) {
